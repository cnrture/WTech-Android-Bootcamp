...
class TamamlananYapilacaklarAdapter(
    private val yapilacaklarList: List<YapilacakModel>,
    private val viewModel: TamamlananYapilacaklarViewModel
) :
    RecyclerView.Adapter<TamamlananYapilacaklarAdapter.YapilacaklarCardTasarim>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.yapilacaklarCardTasarimBinding.onemliCheckBox.isChecked =
            yapilacak.onemliDurum != 0

        holder.yapilacaklarCardTasarimBinding.tamamlandiCheckBox.isChecked =
            yapilacak.tamamlandiDurum != 0
        ...
        holder.yapilacaklarCardTasarimBinding.tamamlandiCheckBox.setOnCheckedChangeListener { compoundButton, b ->
            if (!b) {
                viewModel.tamamlandiDurumDegistir(yapilacak.id, 0)
            }
        }
